<template>
  <div>
    ...
    <home-section
      ...
      alternative
    >
      <vue-headline level="2">ATM SALES</vue-headline>
      <br />
      <vue-headline level="3">GRG</vue-headline>
      <p>Create components, VueX connected components, modules - and their tests - right from the CLI!</p>
      <br />
      <vue-headline level="3">WINCOR</vue-headline>
      <p>
      ...
      <br />
      <vue-headline level="3">NCR</vue-headline>
      <p>
    ...
    <home-section
      ...
      flip
    >
      <vue-headline level="2">ATM SUPPORT</vue-headline>
      <br />
      <vue-headline level="3">GRG</vue-headline>
      <p>
    ...
    <home-section
      ...
      alternative
    >
      <vue-headline level="2">STAFF TRAININGS</vue-headline>
      <br />
      <vue-headline level="3">GRG</vue-headline>
      <p>
    ...
    <home-section
      ...
      flip
    >
      <vue-headline level="2">MISSION</vue-headline>
      <br />
